...
<div class="col-sm-12">
	...
	<div class="col-sm-3">
	No <input type="radio" name="no_check"  value="no" oninput="this.className = ''"/>
    Yes<input type="radio" name="yes_check" id="yes_check" value="yes" oninput="this.className = ''"/>
   </div>
...
<div class="tab">
  ...
  <p><input type="radio" name="nominee_check" value="Nominee" id="nominee_check" placeholder="E-mail..." oninput="this.className = ''"></p>
  </div>
 ...
 @enderror
  ...
  <div class="col-sm-6">
  	...
  	<p>Yes<input type="radio" name="yes" id="account_yes" value="yes_account"  oninput="this.className = ''"/></p>
  	<p>No<input type="radio" name="no"  value="no_account" oninput="this.className = ''"/></p>
  </div>
